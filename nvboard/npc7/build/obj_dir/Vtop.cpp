...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , h0{vlSymsp->TOP.h0}
    , h1{vlSymsp->TOP.h1}
    , light6{vlSymsp->TOP.light6}
    , light5{vlSymsp->TOP.light5}
    , light4{vlSymsp->TOP.light4}
    , light3{vlSymsp->TOP.light3}
    , light2{vlSymsp->TOP.light2}
    , light1{vlSymsp->TOP.light1}
    , en{vlSymsp->TOP.en}
