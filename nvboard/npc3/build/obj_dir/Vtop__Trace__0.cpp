...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+6,((IData)((0U == (IData)(vlSelf->y)))));
    bufp->chgBit(oldp+7,((IData)((1U == (IData)(vlSelf->y)))));
    bufp->chgBit(oldp+8,((IData)((2U == (IData)(vlSelf->y)))));
    bufp->chgBit(oldp+9,((IData)((3U == (IData)(vlSelf->y)))));
}
